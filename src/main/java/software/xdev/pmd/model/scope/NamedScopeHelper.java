...
public final class NamedScopeHelper
{
	...
	/**
	 * Returns the scope with the given id. If no scope with this ID exists, the Scope with the
	 * {@link #DEFAULT_SCOPE_ID} is being returned.
	 */
	@NotNull
	public static NamedScope getScopeByIdWithDefaultFallback(
